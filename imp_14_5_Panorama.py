# 두 영상을 이어 붙여 파노라마 영상 만들기
# from  https://github.com/dltpdn/insightbook.opencv_project_python/

import cv2, numpy as np

# 왼쪽 오른쪽 사진 읽기
#imgL = cv2.imread('images/restaurant1.jpg') # train
#imgR = cv2.imread('images/restaurant2.jpg') # query
imgL = cv2.imread('images/Blender_Suzanne1.jpg') # train
imgR = cv2.imread('images/Blender_Suzanne2.jpg') # query
hl, wl = imgL.shape[:2]
hr, wr = imgR.shape[:2]
